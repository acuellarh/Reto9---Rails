...
Artist.create(name: 'Foo Fighters', image:url:'/assets/foo_fighters.png')
Artist.create(name: 'Queen', image_url: '/assets/queen.png')
Artist.create(name: 'Pearl Jam', image_url: '/assets/pearl_jam.png')
